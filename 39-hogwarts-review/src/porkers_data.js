...
const hogs = oldHogs.map(hog => {
  hog.weight = hog['weight as a ratio of hog to LG - 24.7 Cu. Ft. French Door Refrigerator with Thru-the-Door Ice and Water'];
  delete hog['weight as a ratio of hog to LG - 24.7 Cu. Ft. French Door Refrigerator with Thru-the-Door Ice and Water'];
  hog.medal = hog['highest medal achieved']
  delete hog['highest medal achieved']
  return hog
});
